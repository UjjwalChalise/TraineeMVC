...
public class ModulesController : Controller
{
    ...
    public ModulesController(TraineeDbContext context)
    {
        _context = context;
    }
    ...
    public async Task<IActionResult> Create([Bind("ModuleId,ModuleName,Content,CourseId,Course")] Module module)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? moduleid, [Bind("ModuleId,ModuleName,Content,CourseId,Course")] Module module)
    {
