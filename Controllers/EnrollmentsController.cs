...
public class EnrollmentsController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("EnrollmentId,StudentId,Student,CourseId,Course,EnrolledDate")] Enrollment enrollment)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? enrollmentid, [Bind("EnrollmentId,StudentId,Student,CourseId,Course,EnrolledDate")] Enrollment enrollment)
    {
