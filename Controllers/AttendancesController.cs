...
public class AttendancesController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("AttendanceId,StudentId,Student,CourseId,Course,Date,Status")] Attendance attendance)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? attendanceid, [Bind("AttendanceId,StudentId,Student,CourseId,Course,Date,Status")] Attendance attendance)
    {
