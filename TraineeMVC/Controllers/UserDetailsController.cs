...
public class UserDetailsController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("Id,UserId,User,FirstName,LastName,DateOfBirth,Address,Teacher,Student")] UserDetails userdetails)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? id, [Bind("Id,UserId,User,FirstName,LastName,DateOfBirth,Address,Teacher,Student")] UserDetails userdetails)
    {
