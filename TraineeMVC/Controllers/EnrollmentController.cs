...
namespace TraineeMVC.Controllers
{
    ...
    public class EnrollmentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentId,CourseId,EnrollmentDate,Status")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StudentId,CourseId,EnrollmentDate,Status")] Enrollment enrollment)
        {
            if (id != enrollment.Id)
            {
                return NotFound();
